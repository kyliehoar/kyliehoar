...
public class TrialST {
	...
	static long countCompares(Iterable<ID> iter) {
		int totalCompares = 0;
		for (ID item: iter) {
			totalCompares = totalCompares + item.numCompares();
		}
	 ...
	 */
	static long[] report1(Collection set, SequentialSearchST<ID, Boolean> st) {
	 ...
	 * to a different type and the remaining code will continue to work properly
	 */
	static long[] report2(Collection set, AVLTreeST<ID, Boolean> st) {
		// DO NOT CHANGE ANYTHING INSIDE THIS METHOD!!
		set.resetNumCompares();
		for (ID id: set.ids()) { st.put(id, true); }
	 ...
	 * to a different type and the remaining code will continue to work properly
	 */
	static long[] report3(Collection set, LinearProbingHashST<ID, Boolean> st) {
		// DO NOT CHANGE ANYTHING INSIDE THIS METHOD!!
		set.resetNumCompares();
		for (ID id: set.ids()) { st.put(id, true); }
	 ...
	 * to a different type and the remaining code will continue to work properly
	 */
	static long[] report4(Collection set, BST<ID, Boolean> st) {
		// DO NOT CHANGE ANYTHING INSIDE THIS METHOD!!
		set.resetNumCompares();
		for (ID id: set.ids()) { st.put(id, true); }
	 ...
	 * to a different type and the remaining code will continue to work properly
	 */
	static long[] report5(Collection set, SeparateChainingHashST<ID, Boolean> st) {
		// DO NOT CHANGE ANYTHING INSIDE THIS METHOD!!
		set.resetNumCompares();
		for (ID id: set.ids()) { st.put(id, true); }
